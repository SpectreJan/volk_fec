#ifndef INCLUDED_volk_fec_32f_x2_calc_euclidean_metricpuppet_32f_u_H
#define INCLUDED_volk_fec_32f_x2_calc_euclidean_metricpuppet_32f_u_H
...
static inline void volk_fec_32f_x2_calc_euclidean_metricpuppet_32f_generic(float *c_vector,
                                                    ...
                                                    unsigned int num_points)
{
    ...
    volk_fec_32f_x2_calc_euclidean_metric_32f_manual(metrics, a_vector, b_vector,
                                                   4, 1, num_points, "generic");
    volk_fec_free(metrics);
}

#endif /* LV_HAVE_GENERIC */
#endif /* INCLUDED_volk_fec_32f_x2_calc_euclidean_metricpuppet_32f_u_H */

#ifndef INCLUDED_volk_fec_32f_x2_calc_euclidean_metricpuppet_32f_a_H
#define INCLUDED_volk_fec_32f_x2_calc_euclidean_metricpuppet_32f_a_H
...
static inline void volk_fec_32f_x2_calc_euclidean_metricpuppet_32f_a_sse4(float *c_vector,
                                                    const float *a_vector,
                                                    const float *b_vector,
                                                    unsigned int num_points)
{
...
static inline void volk_fec_32f_x2_calc_euclidean_metricpuppet_32f_a_avx(float *c_vector,
                                                    const float *a_vector,
                                                    const float *b_vector,
                                                    unsigned int num_points)
{
