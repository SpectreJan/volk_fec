#ifndef INCLUDED_volk_fec_32f_s32f_normalize_a_H
#define INCLUDED_volk_fec_32f_s32f_normalize_a_H
...
*/
static inline void volk_fec_32f_s32f_normalize_a_sse(float* vecBuffer, const float scalar, unsigned int num_points){
...
*/
static inline void volk_fec_32f_s32f_normalize_generic(float* vecBuffer, const float scalar, unsigned int num_points){
  unsigned int number = 0;
  float* inputPtr = vecBuffer;
  const float invScalar = 1.0 / scalar;
...
/*!
  ...
  \param num_points The number of values in aVector and bVector to be normalizeed together and stored into cVector
*/
extern void volk_fec_32f_s32f_normalize_a_orc_impl(float* dst, float* src, const float scalar, unsigned int num_points);
static inline void volk_fec_32f_s32f_normalize_u_orc(float* vecBuffer, const float scalar, unsigned int num_points){
    float invscalar = 1.0 / scalar;
    volk_fec_32f_s32f_normalize_a_orc_impl(vecBuffer, vecBuffer, invscalar, num_points);
}
#endif /* LV_HAVE_GENERIC */
...
#endif /* INCLUDED_volk_fec_32f_s32f_normalize_a_H */
